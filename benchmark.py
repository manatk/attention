...
def plot_alpha_summation_benchmarks(alpha_values, benchmark_scores, task, save_path):
    ...
    plt.title(f'Benchmark Scores vs. Alpha Summation Values ({task})')
    plt.legend()
...
def plot_token_retention_benchmarks(token_counts, benchmark_scores, task, save_path):
    ...
    plt.ylabel('Benchmark Scores')
    plt.title(f'Benchmark Scores vs. Token Retention Counts ({task})')
    plt.legend()
    plt.savefig(save_path)
    plt.show()
...
def main():
    ...
    plot_alpha_summation_benchmarks(alpha_values, alpha_benchmark_scores, "Alpha Summation Benchmarks", "alpha_summation_benchmarks.png")
    ...
    plot_token_retention_benchmarks(token_counts, token_benchmark_scores, "Token Retention Benchmarks", "token_retention_benchmarks.png")
